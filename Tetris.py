...
def convert_figure_format(shape):
    positions = []
...
def valid_space(shape, grid):
    ...
    formatted = convert_figure_format(shape)
...
def game():
    ...
    while run:
        ...
        shape_pos = convert_figure_format(current_piece)
    ...
    draw_text_middle("Fool!", 40, (255, 255, 255), win)
    pygame.display.update()
